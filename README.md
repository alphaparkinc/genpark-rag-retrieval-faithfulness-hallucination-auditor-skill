# genpark-rag-retrieval-faithfulness-hallucination-auditor-skill
...
**genpark-rag-retrieval-faithfulness-hallucination-auditor-skill** is a deterministic, zero-dependency Python skill engineered for autonomous AI agents, multi-agent frameworks (Claude Desktop, Cursor, AutoGPT, CrewAI), and enterprise pipelines.

> **Executive Capability**: RAG retrieval faithfulness & hallucination score auditor (Ragas / TruLens)
...
result = client.audit_rag_generation()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-rag-retrieval-faithfulness-hallucination-auditor-skill": {
      "command": "python",
      "args": ["/path/to/genpark-rag-retrieval-faithfulness-hallucination-auditor-skill/mcp_server.py"]
    }
  }
}
```
